...
<section class="consultorio-psicologo-form">
    ...
    <?= $modoEdicion
        ...
        <p>
            <?= $modoEdicion
                ? 'Actualiza los datos administrativos del especialista.'
                : 'Captura los datos esenciales. El especialista activará su cuenta con un enlace seguro; no se solicita contraseña aquí.'; ?>
        </p>
        ...
        <div class="consultorio-dashboard-panel mb-4">
            ...
            <div class="psicologo-access-notice mt-4">
                ...
                <div>
                    ...
                    <p>
                        Se enviará un enlace seguro de un solo uso
                        (válido 24 horas) para que el especialista
                        establezca su propia contraseña. No se
                        envían ni muestran contraseñas.
                    </p>
                </div>
