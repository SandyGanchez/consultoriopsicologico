...
<div class="activacion-card">
    ...
    <?php else: ?>
        ...
        >
            ...
            <?php if (!empty($requiereConsentimiento)): ?>
                <div class="activacion-privacidad mt-3">
                    <?php
                    $versionAviso = $versionAviso ?? '1.0';
                    $idPrefijo = 'act';
        ...
        <script>
            (function () {
                ...
                form.addEventListener('submit', function (e) {
                    var requiere = <?= !empty($requiereConsentimiento) ? 'true' : 'false'; ?>;
                    if (requiere) {
                        ...
                        if (!a || !a.checked || !s || !s.checked) {
                            e.preventDefault();
                            alert('Debes marcar ambas confirmaciones de privacidad para activar la cuenta.');
                            return;
                        }
                    }
                    btn.disabled = true;
