...
public function enviarAccesoConsultorio(
    ...
    try {
        ...
        $mail->Subject =
            'Acceso inicial de tu consultorio';

        $responsableSeguro = htmlspecialchars(
            $nombreResponsable,
            ENT_QUOTES,
            'UTF-8'
        );

        $consultorioSeguro = htmlspecialchars(
            $nombreConsultorio,
            ENT_QUOTES,
            'UTF-8'
        );
    ...
    ">
        ...
        <div style="padding:35px 36px;">
            <h3 style="
                ...
                color:#465149;
            ">
                Tu consultorio fue registrado
            </h3>

            <p>
                Hola <strong>{$responsableSeguro}</strong>:
            </p>

            <p style="line-height:1.7;">
                Se creó la cuenta principal del consultorio
                <strong>{$consultorioSeguro}</strong>.
            </p>
            ...
            <p style="
                ...
                line-height:1.7;
            ">
                Esta contraseña es temporal. Al iniciar sesión por
                primera vez, el sistema solicitará establecer una
                contraseña nueva.
            </p>
...
HTML;
        ...
        $mail->AltBody =
            ...
            "El consultorio {$nombreConsultorio} fue registrado.\n\n" .
            "Correo: {$correoDestino}\n" .
            "Contraseña temporal: {$contrasenaTemporal}\n\n" .
            "Inicia sesión en:\n{$urlLogin}\n\n" .
            "Al ingresar deberás establecer una contraseña nueva.";
        ...
        throw new RuntimeException(
            'No se pudo enviar el correo de acceso inicial.'
        );
    }
}
