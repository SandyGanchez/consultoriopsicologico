...
class HomeController extends Controller
{
    ...
    public function perfilEspecialistaCorto(string $psicologo): void
    {
        ...
        $redesProfesionales = (new \App\Models\RedSocialPsicologo())
            ->listarPublicasPorPsicologo((string) $perfil['ClvPsi']);
    ...
    public function renderPaginaConsultorio(
        ...
        if ($datosPrevios !== null) {
            ...
            $redSocialPsi = new RedSocialPsicologo();

            foreach ($especialistas as &$especialista) {
                $clvPsiEsp = (string) $especialista['ClvPsi'];
                $especialista['servicios'] =
                    $consultorioModel->obtenerServiciosPublicosPsicologo(
                        $clvPsiEsp
                    );
                $especialista['redes'] =
                    $redSocialPsi->listarPublicasPorPsicologo($clvPsiEsp);
            }
            unset($especialista);
