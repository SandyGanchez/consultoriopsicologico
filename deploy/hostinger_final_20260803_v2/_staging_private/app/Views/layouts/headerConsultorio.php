...
>
    <link
        rel="stylesheet"
        href="<?= Helper::assetUrl('assets/css/style.css'); ?>"
    >
    ...
    <link
        rel="stylesheet"
        href="<?= Helper::assetUrl('assets/css/consultorio.css'); ?>"
    >

    <link
        rel="stylesheet"
        href="<?= Helper::assetUrl('assets/css/notificaciones-campana.css'); ?>"
    >
    ...
    <?php if (!empty($cargarDashboardCss)): ?>
        ...
        <link
            ...
            href="<?= Helper::assetUrl(
                'assets/css/consultorio-dashboard.css'
            ); ?>"
        >
