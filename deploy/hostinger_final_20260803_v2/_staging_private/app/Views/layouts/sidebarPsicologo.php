...
<aside class="psychologist-sidebar" id="psychologistSidebar">
    ...
    <nav class="sidebar-menu">
        ...
        <a
            href="<?= Helper::baseUrl('psicologo'); ?>"
            class="sidebar-link <?= preg_match('#/psicologo/?$#', $rutaActual) ? 'active' : ''; ?>">
        ...
        <a
            ...
            class="sidebar-link <?= str_contains($rutaActual, '/psicologo/agenda') || str_contains($rutaActual, '/psicologo/calendario') ? 'active' : ''; ?>">
        ...
        <a
            ...
            class="sidebar-link <?= str_contains($rutaActual, '/psicologo/disponibilidad') ? 'active' : ''; ?>">
