...
<link rel="stylesheet"
      href="<?= \App\Helpers\Helper::assetUrl('assets/css/style.css'); ?>">

<?php require __DIR__ . '/../partials/apariencia-head.php'; ?>

<link rel="stylesheet"
      href="<?= \App\Helpers\Helper::assetUrl('assets/css/home.css'); ?>">

<link rel="stylesheet"
      href="<?= \App\Helpers\Helper::assetUrl('assets/css/navbar.css'); ?>">
