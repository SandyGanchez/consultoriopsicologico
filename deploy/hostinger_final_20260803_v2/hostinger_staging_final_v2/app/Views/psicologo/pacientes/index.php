    ...
    <?php else: ?>
        ...
        <div class="psychologist-patients-grid">
            ...
            <?php foreach ($pacientes as $paciente): ?>
                ...
                $seguimientosPendientesPac = (int) (
                    $paciente['TotalSeguimientosPendientes'] ?? 0
                );

                if ($totalAsistidas > 0 && $totalHistorias === 0) {
                    $etiquetaClinica = 'Historia pendiente';
                    $claseClinica = 'historia-pendiente';
                } elseif ($totalHistorias > 0 && $seguimientosPendientesPac > 0) {
                    $etiquetaClinica = 'Seguimiento pendiente';
                    $claseClinica = 'seguimiento-disponible';
                } elseif ($totalHistorias > 0) {
                    $etiquetaClinica = 'Historia completa';
                    $claseClinica = 'historia-completa';
                } else {
                    $etiquetaClinica = '';
                    $claseClinica = '';
                }
                ...
                <article class="psychologist-patient-card">
                    ...
                    <div class="psychologist-patient-card__top">
                        ...
                        <div class="psychologist-patient-card__identity">
                            ...
                            <?php if ($etiquetaClinica !== ''): ?>
                                <span
                                    class="psychologist-patient-status psychologist-patient-status--<?= htmlspecialchars($claseClinica, ENT_QUOTES, 'UTF-8'); ?>"
                                    style="margin-top:0.35rem;display:inline-block;"
                                >
                                    <?= htmlspecialchars($etiquetaClinica, ENT_QUOTES, 'UTF-8'); ?>
                                </span>
                            <?php endif; ?>
