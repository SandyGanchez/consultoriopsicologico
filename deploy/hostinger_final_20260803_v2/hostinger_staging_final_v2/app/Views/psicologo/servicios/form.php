...
function valorAsignacion(array $datos, string $campo): string
{
    ...
    if (
        ($campo === 'PrecioServicio' || $campo === 'DuracionMinutos')
        && ($valor === 0 || $valor === 0.0 || $valor === '0' || $valor === '0.00')
    ) {
        return '';
    }
...
<section class="psychologist-services-page">
    ...
    <header class="psychologist-services-header">
        ...
        <p>
            Actualiza únicamente el precio y la duración de tu oferta.
            El nombre y la descripción institucionales no se editan aquí.
        </p>
        ...
        >
            ...
            <div class="psychologist-service-form-fields">
                ...
                <div>
                    ...
                    >
                        Debe ser mayor a cero para poder ofrecer el servicio en citas.
                    </small>
