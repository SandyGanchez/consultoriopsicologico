...
class ExpedienteClinicoService
{
    ...
    public function obtenerExpediente(
        ...
        $tieneConsentimiento = !empty($consentimiento['ok']);

        $puedeCrear = $historial === null
        ...
        return [
            ...
            'tieneConsentimientoPrivacidad' => $tieneConsentimiento,
            'mensajeConsentimiento' => $tieneConsentimiento
                ? null
    ...
    public function prepararCreacion(
        ...
        if (empty($consentimiento['ok'])) {
            return [
                'ok' => false,
                'mensaje' => PrivacidadService::MENSAJE_SIN_CONSENTIMIENTO_HISTORIA
            ];
        }
     ...
     * Delegado a PendienteClinicoService (sin persistir notificaciones).
     *
     * @return array{
     *   accion: string,
     *   etiqueta: string,
    ...
    public function resolverAccionClinicaAgenda(
        ...
        return (new PendienteClinicoService())->resolverAccionClinicaAgenda(
            $clvPac,
            $clvPsi,
            $clvCons,
            $clvCita,
