...
$rutaAgendar = Helper::baseUrl('agendar-cita');
if ($sesionActiva && $rol === 'PACIENTE') {
    $rutaAgendar = Helper::baseUrl('paciente/agendar');
}
...
<nav
    id="navbarPublico"
    class="navbar navbar-expand-lg navbar-light sticky-top navbar-public"
                ...
                <ul class="navbar-nav ms-auto align-items-lg-center navbar-public__links">
                    ...
                    <li class="nav-item ms-lg-2 mt-2 mt-lg-0">
                        <?php if ($modoVistaPrevia): ?>
                            <span
                                class="btn rounded-pill px-4 text-white navbar-public__cta navbar-public__cta--disabled"
                        ...
                        <?php else: ?>
                            <a
                                class="btn rounded-pill px-4 text-white navbar-public__cta"
                                href="<?= htmlspecialchars($rutaAgendar, ENT_QUOTES, 'UTF-8'); ?>"
                            >
                                Agendar cita
                            </a>
                        <?php endif; ?>
