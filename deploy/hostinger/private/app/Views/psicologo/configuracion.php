        ...
        <article class="psicologo-config-card">
            <div class="psicologo-config-card__head">
                ...
                <div>
                    <h2>Accesibilidad</h2>
                    <p>
                        Ajusta la lectura en este navegador.
                        Las preferencias se guardan solo de
                        forma local.
                    </p>
                </div>
            </div>

            <div class="psicologo-config-access">
                <fieldset>
                    <legend>Tamaño de fuente</legend>
                    <div class="psicologo-config-chip-row">
                        <button
                            type="button"
                            class="psicologo-config-chip"
                            data-access-font="normal"
                            id="btnFuenteNormal"
                        >
                            Normal
                        </button>
                ...
                <div class="psicologo-config-actions">
                    <button
                        type="button"
                        class="psicologo-config-btn-secondary"
                        id="btnRestablecerAccesibilidad"
                    >
