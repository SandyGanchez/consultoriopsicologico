...
>
        ...
        >
            ...
            <div class="psicologo-brand-logo">
                ...
                <?php if ($logo !== ''): ?>
                    ...
                    <img
                        src="<?= Helper::logotipoConsultorioUrl($logo); ?>"
                        alt="Logotipo"
                    >
    ...
    <nav class="psicologo-menu">
        ...
        <a
            ...
            class="psicologo-menu-link<?=
                menuPsicologoActivo($rutaActual, '/psicologo/agenda') !== ''
                || menuPsicologoActivo($rutaActual, '/psicologo/calendario') !== ''
                    ? ' active'
                    : '';
            ?>"
        >
        ...
        <a
            ...
            class="psicologo-menu-link<?=
                menuPsicologoActivo($rutaActual, '/notificaciones') !== ''
                    ? ' active'
                    : '';
            ?>"
        >
